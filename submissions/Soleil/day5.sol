...
contract AdminOnly{
    ...
    modifier onlyOwner(){
        require(msg.sender==owner,"Access denied:Onlyy the owner can perform this action");
        _;
    }
    ...
    function withdrawTreasure(uint256 amount)public{
        ...
        require(allowance>=amount,"Cannot withdraw more han you are allowed");//condition to check if user is wihdrawing more than allowed
