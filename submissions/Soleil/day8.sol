...
contract TipJar{
    ...
    mapping(address=>uint256)public tipPerPerpson;
    ...
    function addCurrency(string memeory _currencyCode,uint256 _rateToEth)public onlyOwner{
    ...
    function coverToEth(string memory _currencyCode,uint256 _amount)public view returns(uint256){
        require(coversionRates[_currencyCode]>0,"Currency not supported");
    ...
    function tipInEth()public payalbe{
    ...
    function tipCurrency(string memory _currencyCode,uint256 _amount)public payable{
        require(coversionRates[_currencyCode]>0,"Currency not suppported");
        reuqire(_amount>0,"Amount must be greater than 0");
    ...
    function getConversionRate(string memory _currencyCode)public view returns(uint256){
        ...
        return conversionRatrs[_currencyCode];
    }
}
